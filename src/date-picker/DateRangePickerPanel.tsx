...
export default defineComponent({
  ...
  setup(props: TdDateRangePickerPanelProps, { emit, attrs }) {
    ...
    function onJumperClick({
      ...
      const { nextYear, nextMonth, partialIndex } = onJumperClickSharedFn({
        trigger,
        partial,
        mode: props.mode,
        month,
    ...
    function onMonthChange(nextVal: number, { partial }: { partial: DateRangePickerPartial }) {
      const { nextYear, nextMonth, partialIndex } = onMonthChangeChangeSharedFn(nextVal, {
        partial,
        enableTimePicker: props.enableTimePicker,
        activeIndex,
        mode: props.mode,
